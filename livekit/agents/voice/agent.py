...
from .. import llm, stt, tokenize, tts, utils
from .vad import silero  # Or from .vad.silero import SileroVAD
...
class Agent:
    def __init__(
        ...
        *,
        ...
        self._tools = tools.copy() + list(find_function_tools(tools).values())
